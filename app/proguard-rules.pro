...
-keep public class com.moly.hooyee.admob.**
 ...
 -keep public class com.moly.hooyee.facebook.**
  -keep public class com.moly.hooyee.facebook.** {
      *;
  }
...
-keep public class com.moly.hooyee.pranklib.**
-keep public class com.moly.hooyee.pranklib.** {
    *;
}

-keep public class com.moly.hooyee.electricscreen2d.**
-keep public class com.moly.hooyee.electricscreen2d.** {
    *;
}

-keep public class com.moly.hooyee.prank.game.**
-keep public class com.moly.hooyee.prank.game.** {
    *;
}

-keep public class com.moly.hooyee.prank.service.**
-keep public class com.moly.hooyee.prank.service.** {
    *;
}
